...
namespace App\Filament\Resources\Ark\Arks;
...
use App\Filament\Resources\Ark\Arks\Pages\ListArks;
use App\Filament\Resources\Ark\Arks\Pages\EditArk;
...
class ArkResource extends Resource
{
    ...
    {
        return [
            'index' => ListArks::route('/'),
            'edit' => EditArk::route('/edit/{record}'),
            'create' => CreateArk::route('/create'),
        ];
    }
