...
The ARK Management System (AMS) is an open source web application for minting and managing Archival Resource Keys (ARK). It's developed using the [Laravel Framework](https://laravel.com/) and [Filament](https://filamentphp.com/).
...
2. Generate the app key via the command `php artisan key:generate`
